...
export interface ApiGlobalNavigationGlobalNavigation
  ...
  collectionName: 'global-navigations';
  info: {
  ...
  attributes: {
    ...
    navLinks: Schema.Attribute.Component<'elements.label-link', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiPagePage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    useSidebarLayout: Schema.Attribute.Boolean;
  };
}
...
export interface ApiSidebarMenuSidebarMenu extends Struct.CollectionTypeSchema {
  collectionName: 'sidebar-menus';
  info: {
    displayName: 'Sidebar Menu';
    pluralName: 'sidebar-menus';
    singularName: 'sidebar-menu';
  };
  options: {
    draftAndPublish: false;
  };
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::sidebar-menu.sidebar-menu': ApiSidebarMenuSidebarMenu;
